...
/*find all the unique titles within the company - distinct eliminates duplications */
...
that would be your second page, etc. Update the query to find the tenth page of results.*/
